...
class PDFLearningAssistant:
    ...
    def __init__(self, user_id: str = "default_user"):
        ...
        # 初始化工具
        self.memory_tool = MemoryTool(user_id)
    ...
    def load_document(self, pdf_path: str) -> Dict[str, Any]:
        ...
        if not os.path.exists(pdf_path):
            return {"success": False, "message": f"PDF文件:{pdf_path}不存在"}
        ...
        # ragtool加载文档
            ...
            return {
                "success": True,
                "message": f"加载文档成功:{pdf_path}，耗时:{process_time:.2f}秒",
                "document": self.current_document,
            }
        except Exception as e:
            return {"success": False, "message": f"加载文档失败:{pdf_path}， {str(e)}"}
